...
for message in consumer:
    ...
    if os.path.isfile(favorites_filename):
        ...
        print(f'{myconfig.customer_name2}님 시청 기록의 최애 장르 중 관객수 상위 10개의 영화 목록입니다.')
        print(f"Friend received message - Most-watched genre for {myconfig.customer_name2}: {most_watched_genre}")
