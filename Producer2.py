...
watchlist_filename = f'{myconfig.customer_name1}.csv'
...
favorites_filename = f'{myconfig.customer_name1}_favorites.csv'
...
try:
    ...
    producer.send(myconfig.customer_name1, key=most_watched_genre, value=favorites_filename)
    print(f"{myconfig.customer_name1}님이 가장 좋아하시는 영화를 추출했습니다.")
